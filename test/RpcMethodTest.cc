...
#endif // ENABLE_BITTORRENT
  CPPUNIT_ASSERT_EQUAL(std::string("EPISODE=S01E01"),
		  *dctx->commandEnvironment()[std::string("EPISODE")]);
  CPPUNIT_ASSERT(dctx->commandEnvironment().end() ==
		  dctx->commandEnvironment().find(std::string("DEST")));
}
